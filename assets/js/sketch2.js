const fontSize = 14, scaleRate = 6, message = '207498, measles 17947, COVID', message2 = 'ertd7498',
...
function setup() {
    ...
    textSize(fontSize);
    textAlign(LEFT, TOP);
    textData = getTextData(message,message2);
...
function getTextData(message,message2) {
    const data = [];
    text(message, 0, 0);  
     // draw once and get data
